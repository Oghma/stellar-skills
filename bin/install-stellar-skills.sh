...
usage() {
  cat <<'USAGE'
Usage: install-stellar-skills.sh [options]
...
Examples:
  bash bin/install-stellar-skills.sh
  bash bin/install-stellar-skills.sh --target codex --scope-codex project --skills all --on-exists replace --yes
USAGE
}
